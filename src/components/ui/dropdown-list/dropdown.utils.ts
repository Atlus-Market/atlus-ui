...
export const searchDropdownOption = (options: DropdownOption[], value: string): DropdownOption | undefined => {
...
export const getDropdownOptions = (options: DropdownOption[], value: string | string[] | undefined): DropdownOption[] => {
  if (!options || !value) {
    return [];
  }
