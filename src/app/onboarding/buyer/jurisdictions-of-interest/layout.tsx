import { CountriesOfInterestFooter } from '@/app/onboarding/buyer/jurisdictions-of-interest/components/countries-of-interest-footer';
...
export default function CountriesOfInterestLayout({ children }: { children: ReactNode }) {
  return (
