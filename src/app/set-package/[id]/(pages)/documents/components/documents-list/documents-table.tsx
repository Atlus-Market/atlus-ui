import 'src/app/set-package/[id]/(pages)/documents/components/documents-list/documents-table.css';
import { Dataroom } from '@/models/dataroom';
import { Fragment, useMemo } from 'react';
import { parseGMTDate } from '@/utils/date';
import format from 'date-fns/format';
import { FileName } from '@/components/common/file/file-name';
import { DocumentVisibility } from '@/app/set-package/[id]/(pages)/documents/components/documents-list/document-visibility';
import { RemoveDocumentButton } from '@/app/set-package/[id]/(pages)/documents/components/documents-list/remove-document-button';
