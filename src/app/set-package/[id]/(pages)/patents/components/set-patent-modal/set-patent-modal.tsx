...
import { SetPatentForm } from '@/app/set-package/[id]/(pages)/patents/components/set-patent-modal/set-patent-form';
import { SetPatentSaveButton } from '@/app/set-package/[id]/(pages)/patents/components/set-patent-modal/set-patent-save-button';
import { SetPatentFormFields } from '@/app/set-package/[id]/(pages)/patents/components/set-patent-modal/set-patent-form-fields';
