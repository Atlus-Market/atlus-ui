...
import { useShowAddPatentsModal } from '@/app/set-package/[id]/(pages)/patents/hooks/use-show-add-patents-modal';
...
export const Header = ({ familiesCount, patentsCount }: HeaderProps) => {
  ...
  return (
    <div className="flex justify-between items-center mb-8">
      ...
      <AtlusButton variant="outline" onClick={showAddPatentsModal} sizeOld="small">
        Add patents
      </AtlusButton>
    </div>
  );
