...
import { ManageEditedPatent } from '@/app/set-package/[id]/(pages)/patents/components/patents-family-list/patents/manage-edited-patent';
import { getPatentId, getPatentReadableAssignees } from '@/utils/patents';
import { PatentImage } from '@/app/set-package/[id]/(pages)/patents/components/patents-family-list/patents/patent-image';
