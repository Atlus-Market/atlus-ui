...
import { SetPackageDetailsInStore } from '@/app/set-package/(pages)/package-details/set-package-details-in-store';
import { PackageDetailsTitle } from '@/app/set-package/(pages)/package-details/package-details-title';
