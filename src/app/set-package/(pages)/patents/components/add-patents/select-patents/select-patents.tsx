...
import {
  BackButtonModal
} from '@/app/set-package/(pages)/patents/components/add-patents/back-button-modal';
import {
  AddPatentsStep
...
import {
  SelectedPatents
} from '@/app/set-package/(pages)/patents/components/add-patents/select-patents/components/selected-patents';
import {
  CloseAddPatentsModalButton
} from '@/app/set-package/(pages)/patents/components/add-patents/close-add-patents-modal-button';
import {
  SelectPatentsNextButton
} from '@/app/set-package/(pages)/patents/components/add-patents/select-patents/select-patents-next-button';
import {
  SelectPatentSetPatentHandler
} from '@/app/set-package/(pages)/patents/components/add-patents/select-patents/components/select-patent-set-patent-handler';
