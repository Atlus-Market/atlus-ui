...
import {
  ManageEditedPatent
} from '@/app/set-package/(pages)/patents/components/patents-family-list/patents/manage-edited-patent';
    ...
    <div className='flex item-start justify-between px-6 py-4'>
      <div className='flex item-start justify-between'>
        ...
        <div>
          ...
          <div className='mb-7'>
            <span
              className='text-soft-black text-[15px] leading-5 font-medium'>{patent.title}</span>
          </div>
          <div>
