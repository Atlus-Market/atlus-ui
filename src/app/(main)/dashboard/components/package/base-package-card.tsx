...
import { PackageCardWrapper } from '@/app/(main)/dashboard/components/package-card-wrapper';
import { PackageImage } from '@/app/(main)/dashboard/components/package/package-image';
import { PackageTitle } from '@/app/(main)/dashboard/components/package/package-title';
import { MinimumScreenSize } from '@/components/common/minimum-screen-size';
import { PackageFamiliesAndDocuments } from '@/app/(main)/dashboard/components/package/package-families-and-documents';
import { PackageStatusTag } from '@/app/(main)/package/[id]/components/package-status-tag';
import { PackageCreation } from '@/app/(main)/package/[id]/components/package-creation';
