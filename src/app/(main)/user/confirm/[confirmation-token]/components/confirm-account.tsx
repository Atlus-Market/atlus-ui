...
const PageWrapper = ({ children }: { children: ReactNode }) => (
  <div className="w-full h-full flex items-center justify-center flex-col">{children}</div>
);
    ...
    return (
      <PageWrapper>
        ...
        <AtlusSubTitle
          ...
          className="!text-base font-normal mb-8"
        />
        <AtlusButton color="orange" className="mb-4" onClick={() => router.replace(LoginRoute)}>
          Go to Login
        </AtlusButton>
      </PageWrapper>
    );
