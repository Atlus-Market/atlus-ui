...
import { ManageEditedPatent } from '@/app/(main)/set-package/[id]/(pages)/patents/components/patents-family-list/patents/manage-edited-patent';
import { getPatentId, getPatentReadableAssignees } from '@/utils/patents';
import { PatentImage } from '@/app/(main)/set-package/[id]/(pages)/patents/components/patents-family-list/patents/patent-image';
