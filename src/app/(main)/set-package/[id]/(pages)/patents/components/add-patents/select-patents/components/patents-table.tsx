...
import {
  ...
  makeFamilyRowGroups,
} from '@/app/(main)/set-package/[id]/(pages)/patents/components/add-patents/select-patents/components/table/utils';
import { PatentsFamilyGroup } from '@/app/(main)/set-package/[id]/(pages)/patents/components/add-patents/select-patents/components/table/patents-family-group';
import { HeaderRow } from '@/app/(main)/set-package/[id]/(pages)/patents/components/add-patents/select-patents/components/table/header/header-row';
import { usePatentsColumns } from '@/app/(main)/set-package/[id]/(pages)/patents/components/add-patents/select-patents/components/table/column/use-patents-columns';
import { Patent } from '@/models/patent';
import { useTableGroupPatentsByFamily } from '@/app/(main)/set-package/[id]/(pages)/patents/components/add-patents/select-patents/use-table-group-patents-by-family';
import {
...
import { useSetSelectedPatents } from '@/app/(main)/set-package/[id]/(pages)/patents/components/add-patents/select-patents/components/use-set-selected-patents';
