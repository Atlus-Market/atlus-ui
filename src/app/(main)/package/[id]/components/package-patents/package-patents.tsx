...
import { PackagePatentsReducedTable } from '@/app/(main)/package/[id]/components/package-patents/components/package-patents-reduced-table';
import { PackageSectionTitle } from '@/app/(main)/package/[id]/components/package-section-title';
import { ViewPackagePatentsProvider } from '@/app/(main)/package/[id]/components/package-patents/components/view-package-patents/view-package-patents-provider';
import { ViewPackagePatentsModal } from '@/app/(main)/package/[id]/components/package-patents/components/view-package-patents/view-package-patents-modal';
import { SeeAllPatentsButton } from '@/app/(main)/package/[id]/components/package-patents/components/see-all-patents-button';
