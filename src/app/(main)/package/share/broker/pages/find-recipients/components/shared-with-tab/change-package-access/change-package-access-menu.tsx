...
import { PackageAccessMenuItemContent } from '@/app/(main)/package/share/broker/pages/find-recipients/components/shared-with-tab/change-package-access/package-access-menu-item-content';
