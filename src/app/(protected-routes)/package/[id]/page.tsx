import { PackageRightPanel } from '@/app/(protected-routes)/package/[id]/components/right-panel/package-right-panel';
import { MainPanel } from '@/app/(protected-routes)/package/[id]/main-panel';
...
import { NoPackagePermission } from '@/app/(protected-routes)/package/[id]/components/limited-access/request-permission/no-package-permission';
import { loadPackageViewData } from '@/app/(protected-routes)/package/[id]/load-package-view-data';
import { NoPackageSession } from '@/app/(protected-routes)/package/[id]/components/limited-access/no-session/no-package-session';
