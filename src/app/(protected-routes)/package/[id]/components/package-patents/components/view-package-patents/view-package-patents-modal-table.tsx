...
import { PackagePatentsTable } from '@/app/(protected-routes)/package/[id]/components/package-patents/components/package-patents-table';
...
export const ViewPackagePatentsModalTable = ({
  ...
  return (
    <div className="mb-8">
      ...
      {patentsCountDiff > 0 && (
        <div className="w-screen md:w-full flex justify-center mt-3 md:mt-4">
          <AtlusExpandButton
