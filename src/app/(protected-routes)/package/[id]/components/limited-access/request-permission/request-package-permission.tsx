...
import { RequestPackagePermissionTitle } from '@/app/(protected-routes)/package/[id]/components/limited-access/common/request-package-permission-title';
import { RequestPackagePermissionSubtitle } from '@/app/(protected-routes)/package/[id]/components/limited-access/common/request-package-permission-subtitle';
import { AtlusButton } from '@/components/ui/button/atlus-button';
import { useRequestPackagePermission } from '@/app/(protected-routes)/package/[id]/components/limited-access/request-permission/use-request-package-permission';
...
import { PackagePageProps } from '@/app/(protected-routes)/package/[id]/page';
