...
import { ShareBuyerPackageButton } from '@/app/(protected-routes)/package/share/buyer/components/share-buyer-package-button';
import { ShareBuyerPackageForm } from '@/app/(protected-routes)/package/share/buyer/components/share-buyer-package-form';
import { ShareBuyerPackageFormFields } from '@/app/(protected-routes)/package/share/buyer/components/share-buyer-package-form-fields';
...
export const ShareBuyerPackageBody = () => {
  ...
  return (
    <ShareBuyerPackageForm onSubmit={mutateAsync} onPackageShared={hideSharePackageModal}>
      <AtlusModalContainer
        header={
          <AtlusModalHeader
