...
export const documentsReducer = {
  ...
  updateFileUploadState: (
    state: SetPackageState,
    action: PayloadAction<UploadingFileState>
  ) => {
  ...
  removeDocument: (
    ...
    removeDirectoryTree(
      state.documents.dataroom.directoryTree,
      action.payload.documentId
    );
  },
};
...
export const createDocumentsExtraReducers = (
  ...
  builder.addCase(
    uploadPackageDocument.pending,
    (state: SetPackageState, action) => {
      const { meta } = action;
  ...
  builder.addCase(
    uploadPackageDocument.fulfilled,
    (state: SetPackageState, action) => {
  ...
  builder.addCase(
    uploadPackageDocument.rejected,
    (state: SetPackageState, action) => {
